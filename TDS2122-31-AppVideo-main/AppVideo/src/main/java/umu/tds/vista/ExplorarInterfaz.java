...
public class ExplorarInterfaz {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					ExplorarInterfaz window = new ExplorarInterfaz(null,new VideoWeb(), new ArrayList<Video>());
	 ...
	 */
	public ExplorarInterfaz(Usuario usuario, VideoWeb video, ArrayList<Video> arrayList) {
	...
	private void initialize() {
		...
		buscarBoton.setIcon(new ImageIcon(ExplorarInterfaz.class.getResource("/resources/lupa.png")));
		...
		luz.addEncendidoListener(new IEncendidoListener() {
			...
			public void enteradoCambioEncendido(EventObject arg0) {
				...
				if (fichXML == JFileChooser.APPROVE_OPTION) {
					...
					frame.dispose();
					ExplorarInterfaz e = new ExplorarInterfaz(usuario, videoweb, videosRecientes);
					e.mostrarVentana();
